...
<div class="content-wrapper">
    ...
    <div class="content-header d-flex justify-content-start">
        {!! \App\Library\Html::linkBack(route('admin.employee.show', $employee->id).'#tab-note') !!}
        <div class="d-block">
    ...
    <div class="card shadow-sm col-lg-8  col-md-12">
        <div class="card-body py-sm-4">
            <form method="post" class="form" action="{{ route('admin.employee.prescription.create', $employee->id) }}" enctype="multipart/form-data">
                @csrf
